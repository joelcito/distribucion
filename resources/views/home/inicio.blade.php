            ...
            <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('assets/media/stock/900x600/42.png')">
                <div class="mb-10">
                    <div class="fs-2hx fw-bold text-gray-800 text-center mb-13">
                        <span class="me-2">Sistema de Control de Invetarios.
                        <br />
                    </div>
                </div>
                                ...
                                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end" style="background-color: #F1416C;background-image:url('assets/media/patterns/vector-1.png');">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            <!--begin::Amount-->
                                            <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ $cantFactura }}</span>
                                            <!--end::Amount-->
                                            <!--begin::Subtitle-->
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end" style="background-color: #4d41f1;background-image:url('assets/media/patterns/vector-1.png');">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            <!--begin::Amount-->
                                            <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ $cantRecibo }}</span>
                                            <!--end::Amount-->
                                            <!--begin::Subtitle-->
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end" style="background-color: #f18241;background-image:url('assets/media/patterns/vector-1.png');">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            <!--begin::Amount-->
                                            <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ $cantFactura + $cantRecibo }}</span>
                                            <!--end::Amount-->
                                            <!--begin::Subtitle-->
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end" style="background-color: #3e7213;background-image:url('assets/media/patterns/vector-1.png');">
                                    ...
                                    <div class="card-header pt-5">
                                        ...
                                        <div class="card-title d-flex flex-column">
                                            <!--begin::Amount-->
                                            <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ $cantUsuarios }}</span>
                                            <!--end::Amount-->
                                            <!--begin::Subtitle-->
                                ...
                                <div style="overflow-x: auto;">
                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                        ...
                                        <tbody class="text-gray-600 fw-semibold">
                                            @forelse ( $pedidos as $pe)
                                                <tr>
                                                    <td>{{ $pe->sucursal_nombre }}</td>
                                                    <td>{{ $pe->producto_nombre }}</td>
                                                    <td>{{ $pe->minimo_stock }}</td>
                                                    <td>{{ $pe->total  }}</td>
                                                </tr>
                                            @empty
...
<script>
    ...
    function dibujarGraficos() {
            // Datos de factura y Recibo
            var datosFacturaRecibo = google.visualization.arrayToDataTable([
                ['Tipo', 'Cantidad'],
                ['Factura', {{ $cantFactura }}],
                ['Recibo', {{ $cantRecibo }}],
            ]);

            var opcionesFacturaRecibo = { title: 'Cantidad de Ventas Facturas y Recibos' };
            chartFacturaRecibo = new google.visualization.PieChart(document.getElementById('chartFacturaRecibo'));
            chartFacturaRecibo.draw(datosFacturaRecibo, opcionesFacturaRecibo);
