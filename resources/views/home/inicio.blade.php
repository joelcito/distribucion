                                    ...
                                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end"
                                        ...
                                        <div class="card-header pt-5">
                                            ...
                                            <div class="card-title d-flex flex-column">
                                                ...
                                                <!--end::Amount-->
                                                <!--begin::Subtitle-->
                                                <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Facturas del
                                                    Día</span>
                                                <!--end::Subtitle-->
                                            </div>
                                            <!--end::Title-->
                                    ...
                                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end"
                                        ...
                                        <div class="card-header pt-5">
                                            ...
                                            <div class="card-title d-flex flex-column">
                                                ...
                                                <!--end::Amount-->
                                                <!--begin::Subtitle-->
                                                <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Recibos del
                                                    Día</span>
                                                <!--end::Subtitle-->
                                            </div>
                                            <!--end::Title-->
                                    ...
                                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end"
                                        ...
                                        <div class="card-header pt-5">
                                            ...
                                            <div class="card-title d-flex flex-column">
                                                ...
                                                <!--end::Amount-->
                                                <!--begin::Subtitle-->
                                                <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Total Ventas del
                                                    Día</span>
                                                <!--end::Subtitle-->
                                            </div>
                                            <!--end::Title-->
...
@section('js')
    ...
    <script>
        ...
        function dibujarGraficos() {
            ...
            var opcionesFacturaRecibo = {
                title: 'Cantidad de Ventas Facturas y Recibos'
            };
